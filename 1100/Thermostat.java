    ...
    public class MainClass {
        ...
        private static void solve() {
            ...
            if(a == b){
                fw.out.println(0);
            }else if(Math.abs(a-b) >= x) fw.out.println(1);
            else if(r - Math.max(a, b) >= x ||  Math.min(a, b) - l >= x) fw.out.println(2);
            else if((r - b >= x && a - l >= x) || (r - a >= x && b - l >= x)) fw.out.println(3);
            else fw.out.println(-1);
